...
= 1.3.2 =
* Fix aggiornamento da GitHub: consentito anche con installazione Git, niente zipball sorgente
* Download GitHub più affidabile (timeout, header corretti)
* Migrazione automatica alla cartella canonica casa-vacanza-prenotazioni
* verify_install non blocca più aggiornamenti riusciti

= 1.3.1 =
* Fix aggiornamento WordPress: riconoscimento zip più robusto, rinomina cartella e percorso attivo corretto
* Messaggi di errore installazione più chiari
